  ...
  return (
    <View className="flex-1 bg-permuta-background">
      ...
      <View className="flex-1 p-4 -my-2">
        <View className="my-2">
          ...
          <View className="flex-row justify-between">
            ...
            <View className="items-end justify-between py-1">
              ...
              <Text className="text-2xl text-permuta-text">₵638.99</Text>
            </View>
          </View>
        </View>
        {isAuction && (
        ...
        <View className="my-2">
          <Text style={{ fontFamily: FONT.Nunito.Medium }}>Description</Text>
          <Text
            style={{ fontFamily: FONT.Nunito.Medium }}
            className="text-slate-600"
          >
            Lorem ipsum dolor sit amet consectetur. Interdum egestas scelerisque
            leo sem volutpat. Feugiat at tincidunt diam facilisi sed platea duis
            id. Tellus eget fermentum mi facilisi nisi dictumst. Ipsum tristique
            posuere amet nisi viverra aenean sit orci enim.
          </Text>
        </View>
        <View className="my-2 items-start">
          <View className=" border rounded-lg py-1 px-4">
            <Text className="text-xs">USED</Text>
          </View>
        </View>
      </View>
      <View style={{ marginBottom: insets.bottom }} className="p-4">
        ...
        <FillButton
          onPress={() => {
            if (isAuction) {
              return router.push("/item/4/place-bid-modal");
            } else {
              return router.push("/item/4/ask-to-buy");
            }
          }}
